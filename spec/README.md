# spec 索引 — figma-prototyper

阅读顺序：01 → 02 → 03 → 07；验收对照 05/06；工具型 UI 说明见 04。

| # | 文档 | 角色 | 验收前缀 | 状态 |
|---|---|---|---|---|
| 01 | [01-product-scope.md](01-product-scope.md) | 产品范围、角色、非目标 | — | 已定稿 |
| 02 | [02-domain-and-workflows.md](02-domain-and-workflows.md) | Job 状态机、token 预算、认领协议 | — | 已定稿 |
| 03 | [03-system-architecture.md](03-system-architecture.md) | 组件、WS 消息协议、文件契约、安全边界 | — | 已定稿（M1 部分实现） |
